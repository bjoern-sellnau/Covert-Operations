  ...
  return (
    <div style={{ position: 'absolute', inset: 0, overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        <div style={{ width: 340, height: 1, background: 'rgba(224,84,24,0.5)', marginBottom: 40 }} />

        <div style={{ display: 'flex', flexDirection: 'column', gap: 4, width: 340 }}>
          {items.map((item) => {
