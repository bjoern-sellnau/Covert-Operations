...
export const WEAPON_CONFIGS: Record<WeaponId, WeaponConfig> = {
  ...
  plasma:  { name: 'Plasma-Werfer',        shortName: 'PLSM',  price: 320, baseDamage: 8,   pellets: 1, spread: 0,    shootCooldown: 0.7,   bulletSpeed: 20, baseAmmo: 15,  statDamage: 5, statRate: 2, statRange: 3, reloadTime: 3.0, description: 'Explosives Projektil bei Einschlag (Radius 2.5m).', isProjectile: true, projectileSpeed: 20, projectileRadius: 2.5, projectileDamage: 30 },
  bazooka: { name: 'Panzerfaust RPG',      shortName: 'RPG',   price: 380, baseDamage: 20,  pellets: 1, spread: 0,    shootCooldown: 1.2,   bulletSpeed: 32, baseAmmo: 8,   statDamage: 5, statRate: 1, statRange: 4, reloadTime: 3.5, description: 'Schwere Rakete. Massiver Splash-Schaden (Radius 4.5m).', isProjectile: true, projectileSpeed: 32, projectileRadius: 4.5, projectileDamage: 70 },
  ...
  bfg:       { name: 'BFG-9000',         shortName: 'BFG',  price: 500, baseDamage: 999, pellets: 1, spread: 0, shootCooldown: 2.5, bulletSpeed: 22, baseAmmo: 3,   statDamage: 5, statRate: 1, statRange: 5, reloadTime: 4.5, description: 'Massive grüne Plasmakugel. Vernichtet alle Gegner im Umkreis (Radius 12m). Spieler ist immun.', isProjectile: true, projectileSpeed: 22, projectileRadius: 12, projectileDamage: 999 },
