export type GamePhase = 'splash' | 'title_screen' | 'singleplayer_menu' | 'multiplayer_menu' | 'debug_menu' | 'menu' | 'character_select' | 'game_modes' | 'missions' | 'briefing' | 'cutscene' | 'mutators' | 'lobby' | 'options' | 'track_player' | 'shop' | 'map_select' | 'playing' | 'gameover' | 'editor' | 'skydive' | 'skydive_win' | 'help' | 'demo_viewer'
