export type GamePhase = 'splash' | 'title_screen' | 'singleplayer_menu' | 'multiplayer_menu' | 'debug_menu' | 'menu' | 'character_select' | 'game_modes' | 'missions' | 'briefing' | 'cutscene' | 'mutators' | 'rules' | 'lobby' | 'options' | 'track_player' | 'shop' | 'map_select' | 'playing' | 'gameover' | 'editor' | 'skydive' | 'skydive_v1' | 'skydive_v3' | 'skydive_win' | 'help' | 'demo_viewer'
...
export const WEAPON_CONFIGS: Record<WeaponId, WeaponConfig> = {
  ...
  plasma:  { name: 'Plasma-Werfer',        shortName: 'PLSM',  price: 320, baseDamage: 8,   pellets: 1, spread: 0,    shootCooldown: 0.7,   bulletSpeed: 14, baseAmmo: 15,  statDamage: 5, statRate: 2, statRange: 3, reloadTime: 3.0, description: 'Explosives Projektil bei Einschlag (Radius 2.5m).', isProjectile: true, projectileSpeed: 14, projectileRadius: 2.5, projectileDamage: 30 },
  bazooka: { name: 'Panzerfaust RPG',      shortName: 'RPG',   price: 380, baseDamage: 20,  pellets: 1, spread: 0,    shootCooldown: 1.2,   bulletSpeed: 20, baseAmmo: 8,   statDamage: 5, statRate: 1, statRange: 4, reloadTime: 3.5, description: 'Schwere Rakete. Massiver Splash-Schaden (Radius 4.5m).', isProjectile: true, projectileSpeed: 20, projectileRadius: 4.5, projectileDamage: 70 },
  ...
  bfg:       { name: 'BFG-9000',         shortName: 'BFG',  price: 500, baseDamage: 999, pellets: 1, spread: 0, shootCooldown: 2.5, bulletSpeed: 12, baseAmmo: 3,   statDamage: 5, statRate: 1, statRange: 5, reloadTime: 4.5, description: 'Massive grüne Plasmakugel. Vernichtet alle Gegner im Umkreis (Radius 12m). Spieler ist immun.', isProjectile: true, projectileSpeed: 12, projectileRadius: 12, projectileDamage: 999 },
