export type GamePhase = 'title_screen' | 'singleplayer_menu' | 'multiplayer_menu' | 'menu' | 'character_select' | 'missions' | 'briefing' | 'cutscene' | 'mutators' | 'lobby' | 'options' | 'shop' | 'playing' | 'gameover' | 'editor' | 'skydive' | 'skydive_win' | 'help' | 'demo_viewer'
