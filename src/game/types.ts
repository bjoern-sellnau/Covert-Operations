export type GamePhase = 'title_screen' | 'menu' | 'character_select' | 'missions' | 'briefing' | 'cutscene' | 'mutators' | 'lobby' | 'options' | 'shop' | 'playing' | 'gameover' | 'editor' | 'skydive' | 'skydive_win' | 'help' | 'demo_viewer'
