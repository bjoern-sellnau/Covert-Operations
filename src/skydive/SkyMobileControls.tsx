...
function SkyBtn({ label, color, bg, size, sub, onDown, onUp }: {
  ...
  return (
    <div
      ...
      style={{
        ...
        fontSize: size >= 74 ? 13 : 11, fontWeight: 'bold',
...
export function SkyMobileControls() {
  ...
  function onJoyDown(e: React.PointerEvent) {
    ...
    if (baseRef.current) baseRef.current.style.background = 'rgba(255,136,0,0.18)'
    ...
    <div style={{
      ...
      <div
        ...
        style={{
          ...
          boxShadow: '0 0 16px rgba(255,136,0,0.3)',
          pointerEvents: 'auto', touchAction: 'none',
        }}
      ...
      >
        <div style={{ position: 'absolute', top: 0, right: 0, bottom: 0, left: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', pointerEvents: 'none' }}>
          <div style={{ position: 'absolute', top: 8, fontSize: 14, color: 'rgba(255,136,0,0.5)', lineHeight: 1 }}>▲</div>
          <div style={{ position: 'absolute', bottom: 8, fontSize: 14, color: 'rgba(255,136,0,0.5)', lineHeight: 1 }}>▼</div>
          <div style={{ position: 'absolute', left: 8, fontSize: 14, color: 'rgba(255,136,0,0.5)', lineHeight: 1 }}>◀</div>
          <div style={{ position: 'absolute', right: 8, fontSize: 14, color: 'rgba(255,136,0,0.5)', lineHeight: 1 }}>▶</div>
        </div>
        <div ref={thumbRef} style={{
          position: 'absolute', top: '50%', left: '50%',
          width: 54, height: 54, borderRadius: '50%',
          background: 'rgba(255,136,0,0.5)',
          border: '3px solid rgba(255,180,0,0.9)',
      ...
      <div style={{
        ...
        <SkyBtn
          label="CHUTE" color="#ff8800" bg="rgba(100,50,0,0.75)" size={74}
