...
export function App() {
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', position: 'relative', overflow: 'hidden' }}>
      {/* Canvas wrapper — CSS filter for bullet-time desaturation */}
      <div
        style={{
          position: 'absolute',
          inset: 0,
      ...
      {/* Bullet-time chromatic aberration scanlines */}
      {isBulletTime && (
        <div
          style={{
            position: 'absolute',
            ...
            pointerEvents: 'none',
            backgroundImage:
              'repeating-linear-gradient(0deg, transparent, transparent 3px, rgba(0,100,220,0.04) 3px, rgba(0,100,220,0.04) 4px)',
